...
extern int UWB_INTERP_WINDOW_SIZE;
...
extern int USE_UWB_CORRECTED_OUTPUT;
extern double UWB_CORRECTED_OUTPUT_MAX_NORM;
extern double UVINS_CORRECTION_MAX_NORM;
extern double UVINS_CORRECTION_MAX_FINAL_COST;
extern double UVINS_CORRECTION_MAX_DELTA_NORM;
extern double UVINS_CORRECTED_OUTPUT_SMOOTHING_ALPHA;
extern double UVINS_CORRECTED_OUTPUT_MAX_DELTA_NORM;
extern double UVINS_CORRECTED_OUTPUT_MAX_REUSE_TIME;
extern double UVINS_CORRECTION_MAX_ABS_Z;
extern double UVINS_CORRECTED_OUTPUT_DAMP_Z;
extern double UVINS_UWB_RESIDUAL_WEIGHT;
extern double UVINS_VIO_RESIDUAL_WEIGHT;
extern double UVINS_SMOOTH_RESIDUAL_WEIGHT;
extern int USE_UVINS_VECTOR_UWB_RESIDUAL;
extern int USE_UVINS_CORRECTED_OUTPUT;
